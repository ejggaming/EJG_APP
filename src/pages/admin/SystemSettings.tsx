...
export default function SystemSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Draw Schedule */}
      <div>
        <h2 className="text-lg font-bold text-white mb-3">Draw Schedule</h2>
        <Card>
            ...
            {drawTimes.map((dt) => (
              ...
              >
                ...
                <input
                  ...
                  className="bg-surface-card text-white text-sm px-3 py-1.5 rounded border border-gray-700/50 focus:outline-none focus:border-brand-red"
                  disabled={!dt.enabled}
                />
              </div>
            ))}
          ...
          <div className="mt-3 p-3 bg-surface-bg rounded-lg">
            ...
            <div className="flex gap-4 mt-2">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs text-gray-300">Gov't {govShare}%</span>
              </div>
              <div className="flex items-center gap-1">
      ...
      {/* System */}
      <div>
        <h2 className="text-lg font-bold text-white mb-3">System</h2>
        <Card>
            ...
            <div className="p-3 bg-surface-bg rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  <p className="text-gray-300">1.0.0-beta</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-300">Feb 19, 2026</p>
                </div>
              </div>
            </div>
          </div>
